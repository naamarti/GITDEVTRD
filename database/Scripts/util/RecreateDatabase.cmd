...
call %DEPLOY_LOGGER% "    Creating Database..."
call %DEPLOY_LOGGER% ""
call %DEPLOY_LOGGER% "----------------------------------------------------------"
call %DEPLOY_LOGGER% ""

set CREATE_FILE=%TEMP_SCRIPT_DIR%\DatabaseCreate.sql

call %UTIL_SCRIPT_DIR%\GenerateScriptDatabaseCreate.cmd %DATABASE_NAME% %CREATE_FILE%
if ERRORLEVEL 1 (EXIT /b 1)

call %UTIL_SCRIPT_DIR%\RunDatabaseCommandFromInputFile.cmd master %CREATE_FILE%
if ERRORLEVEL 1 (EXIT /b 1)
