...
public class WindowsMoveDirectoryProcess
{
	protected static final Log log = LogFactory.getLog(WindowsMoveDirectoryProcess.class);
	...
	public static boolean runProcess(String sourceDir, String destDir) throws Exception 
	{
		...
		//Recreate top level sourceDir, as it may be removed during MOVE operation
		//IOUtility.createDirectoryIfNotExists(sourceDir);
	...
	public static void main(String args[])
	{
		...
		String sourceDir = System.getenv("DMS_HOME")+"/data/TestFileIO/TestMoveFrom/";
		String destDir = System.getenv("DMS_HOME")+"/data/TestFileIO/TestMoveTo/";
