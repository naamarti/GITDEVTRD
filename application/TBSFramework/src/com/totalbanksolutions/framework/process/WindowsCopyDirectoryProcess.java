...
public class WindowsCopyDirectoryProcess
{
	protected static final Log log = LogFactory.getLog(WindowsCopyDirectoryProcess.class);
	...
	public static void main(String args[])
	{
		...
		String sourceDir = System.getenv("DMS_HOME")+"/data/Working/Clearview/";
		String destDir = System.getenv("DMS_HOME")+"/data/";
