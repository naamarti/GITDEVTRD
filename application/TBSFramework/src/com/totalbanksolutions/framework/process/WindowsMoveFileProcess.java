...
public class WindowsMoveFileProcess
{
	protected static final Log log = LogFactory.getLog(WindowsMoveFileProcess.class);
	...
	public static boolean runProcess(String sourceDir, String destDir, String fileName) throws Exception 
	{
		...
		commands.add("/c");
		commands.add("startMoveFile.cmd");
	...
	public static void main(String args[])
	{
		...
		String javaHome = System.getenv("DMS_HOME");
		String sourceDir = javaHome + "/data/Working/";
		String destDir = javaHome + "/";
		String fileName = "monthendfiles.xls";
