...
public class WindowsCopyFileProcess
{
	protected static final Log log = LogFactory.getLog(WindowsCopyFileProcess.class);
	...
	public static boolean runProcess(String sourceDir, String destDir, String fileName) throws Exception 
	{
		...
		if(!IOUtility.fileExists(sourceDir + fileName))
		{
			throw new RuntimeException("Source file '" + sourceDir + fileName + "' does not exist!");
		}
		if(!IOUtility.directoryExists(destDir))
		{
		...
		commands.add("/c");
		commands.add("startCopyFile.cmd");
	...
	public static void main(String args[])
	{
		...
		String sourceDir = "//10.160.2.15/tbs_files/Daily Production/Ridge Clearing/Archive/2008/2008.12/December 31/Afternoon/Files.Confirmation/";
		String destDir = System.getenv("DMS_HOME")+"/data/TestFileIO/TestMoveFrom/";
		//String fileName = "deutsche-bank-file.data";
		//String fileName = "2008.12.31.Legent Clearing LLC.Confirmation.(0).OUT.Beta.sb.081230.dat";
		//String fileName = "test2.txt";
		String fileName = "2008.12.31.Ridge Clearing.Confirmation.(0).OUT.Broadridge.sb.081231.dat";
		
		try
		{
			isSuccess = runProcess(sourceDir, destDir, fileName);
		}
		catch(Exception e)
		{
