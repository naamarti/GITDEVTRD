...
//	}
	...
	/**
	 * Constructor taking only the money amount as string representation.
	 * 
	 * <P>
	 * The currency and rounding style both take default values.
	 * 
	...
	public String toString() 
	{
		...
		return myFormatter.format(fAmount.doubleValue());
	}
...
//		Money.init( Currency.getInstance("USD"), RoundingMode.HALF_EVEN);
		Money amountOne = new Money("6500.23");
		Money amountTwo = new Money("523.23");

		System.out.println("amount one is : " + amountOne );
		System.out.println("amount two is : " + amountTwo );
		System.out.println("amountOne - ammountTwo = " + amountOne.minus(amountTwo) );
