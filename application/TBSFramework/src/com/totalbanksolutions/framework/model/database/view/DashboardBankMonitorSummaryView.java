 ...
 * =================================================================================================
 */
public class DashboardBankMonitorSummaryView extends DefaultModelTable
{	

	public final String BANK_NAME					= "bankName";
	public final String FDIC_CERT					= "fdicCertNum";
	...
	public DashboardBankMonitorSummaryView()
	{
	...
	private void initializeColumns()
	{
		...
		this.addColumn( this.FDIC_CERT,				"FDICCertificateNumber",	DatabaseDataType.CHAR,				20,		"FDIC Cert",						"FDIC Certificate Number" 					);
		this.addColumn( this.ASSETS,				"Assets",					DatabaseDataType.DECIMAL_AMOUNT,	0,		"Assets, $K",						"Bank Assets in $K" 						);
		this.addColumn( this.IRA_QUALITY_SCORE,		"IRAQualityScore",			DatabaseDataType.DECIMAL_AMOUNT,	0,		"IRA Qlty",							"IRA Counterpary Quality Score" 			); 
		this.addColumn( this.REG_CAPITAL_ADEQUACY,	"RegCapitalAdequacy",		DatabaseDataType.CHAR,				50,		"Reg Cap Adeq",						"Regulatory Capital Adequacy" 				);
		this.addColumn( this.IRA_SHADOW_CAMELS,		"IRAShadowCamels",			DatabaseDataType.DECIMAL_AMOUNT,	0,		"IRA CAMELS",						"IRA Shadow CAMELS" 						); 
