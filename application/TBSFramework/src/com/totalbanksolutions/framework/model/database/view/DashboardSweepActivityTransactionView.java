 ...
 * =================================================================================================
 */
public class DashboardSweepActivityTransactionView extends DefaultModelTable
{	
	...
	public DashboardSweepActivityTransactionView()
	{
		initializeColumns();
	}
	...
	private void initializeColumns()
	{
		...
		this.addColumn( this.ACCOUNT_LINK,			"AccountLink",		        DatabaseDataType.CHAR,				50,		"Account Link",			    "account link"                                );
