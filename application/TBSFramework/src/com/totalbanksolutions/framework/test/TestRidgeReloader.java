 ...
 * 
 */
public class TestRidgeReloader extends TestReloader
{
	protected final Log log = LogFactory.getLog(getClass());
	
	public static void main(String[] args) 
	{
		String programCode = Program.Values.PENSON_NY.getId();
		String sourceInstitutionCode = SourceInstitution.Values.RIDGE.getId();
		String userName = "tbs_Val.Catrini";
		Date endDate = ConvertUtility.convertToDate(2009, 11, 12);

		TestRidgeReloader test = new TestRidgeReloader();
