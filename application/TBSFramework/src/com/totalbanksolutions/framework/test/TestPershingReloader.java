 ...
 * 
 */
public class TestPershingReloader extends TestReloader
{
	protected final Log log = LogFactory.getLog(getClass());
	
	public static void main(String[] args) 
	{
		String programCode = Program.Values.PERSHING.getId();
		String sourceInstitutionCode = SourceInstitution.Values.PERSHING.getId();
		String userName = "tbs_Dan.Merkel";
		Date endDate = ConvertUtility.convertToDate(2010, 9, 15);

		TestPershingReloader test = new TestPershingReloader();
