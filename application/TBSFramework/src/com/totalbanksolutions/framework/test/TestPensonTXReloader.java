 ...
 * 
 */
public class TestPensonTXReloader extends TestReloader
{
	protected final Log log = LogFactory.getLog(getClass());
	
	public static void main(String[] args) 
	{
		String programCode = Program.Values.PENSON_TEXAS.getId();
		String sourceInstitutionCode = SourceInstitution.Values.PENSON_TEXAS.getId();
		String userName = "tbs_Dan.Merkel";
		Date endDate = ConvertUtility.convertToDate(2010, 07, 21);

		TestPensonTXReloader test = new TestPensonTXReloader();
