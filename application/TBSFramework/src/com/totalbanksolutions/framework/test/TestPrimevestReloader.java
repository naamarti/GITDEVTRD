 ...
 * 
 */
public class TestPrimevestReloader extends TestReloader
{
	protected final Log log = LogFactory.getLog(getClass());
	
	public static void main(String[] args) 
	{
		String programCode = Program.Values.PRIMEVEST.getId();
		String sourceInstitutionCode = SourceInstitution.Values.PRIMEVEST.getId();
		String userName = "tbs_Val.Catrini";
		Date endDate = ConvertUtility.convertToDate(2009, 11, 27);

		TestPrimevestReloader test = new TestPrimevestReloader();
