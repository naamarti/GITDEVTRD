 ...
 * 
 */
public class TestHilliardLyonsReloader extends TestReloader
{
	protected final Log log = LogFactory.getLog(getClass());
	
	public static void main(String[] args) 
	{
		String programCode = Program.Values.HILLIARD_LYONS.getId();
		String sourceInstitutionCode = SourceInstitution.Values.HILLIARD_LYONS.getId();
		String userName = "tbs_Val.Catrini";
		Date endDate = ConvertUtility.convertToDate(2009, 11, 02);

		TestHilliardLyonsReloader test = new TestHilliardLyonsReloader();
