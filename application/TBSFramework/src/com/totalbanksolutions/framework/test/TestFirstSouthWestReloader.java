 ...
 *  
 */
public class TestFirstSouthWestReloader extends TestReloader
{
	protected final Log log = LogFactory.getLog(getClass());
	
	public static void main(String[] args) 
	{
		String programCode = Program.Values.FIRST_SOUTH_WEST.getId();
		String sourceInstitutionCode = SourceInstitution.Values.FIRST_SOUTH_WEST.getId();
		String userName = "tbs_Val.Catrini";
		Date endDate = ConvertUtility.convertToDate(2009, 9, 18);

		TestFirstSouthWestReloader test = new TestFirstSouthWestReloader();
