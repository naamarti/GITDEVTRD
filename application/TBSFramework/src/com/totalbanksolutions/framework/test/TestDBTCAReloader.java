 ...
 * 
 */
public class TestDBTCAReloader extends TestReloader
{
	protected final Log log = LogFactory.getLog(getClass());
	
	public static void main(String[] args) 
	{
		String programCode = Program.Values.DBTCA.getId();
		String sourceInstitutionCode = SourceInstitution.Values.NONE.getId();
		String userName = "tbs_Val.Catrini";
		Date endDate = ConvertUtility.convertToDate(2009, 10, 30);

		TestDBTCAReloader test = new TestDBTCAReloader();
